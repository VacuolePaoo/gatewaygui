...
pub struct SecurityManager {
    /// 当前安全配置
    config: Arc<tokio::sync::RwLock<crate::gateway::tauri_api::SecurityConfig>>,
    /// 访问控制规则
    access_rules: Arc<dashmap::DashMap<String, crate::gateway::tauri_api::AccessRule>>,
    /// 活跃会话
    active_sessions: Arc<dashmap::DashMap<String, crate::gateway::tauri_api::ActiveSession>>,
}
...
impl SecurityManager {
    ...
    pub async fn new() -> anyhow::Result<Self> {
        let default_config = crate::gateway::tauri_api::SecurityConfig {
            tls_enabled: true,
    ...
    ///
    /// 当前安全配置
    pub async fn get_config(&self) -> anyhow::Result<crate::gateway::tauri_api::SecurityConfig> {
    ...
    ///
    /// 操作结果
    pub async fn update_config(&self, new_config: crate::gateway::tauri_api::SecurityConfig) -> anyhow::Result<()> {
        // 验证配置
    ...
    /// 验证安全配置
    fn validate_security_config(&self, config: &crate::gateway::tauri_api::SecurityConfig) -> anyhow::Result<()> {
    ...
    pub async fn generate_certificate(
        &self,
        cert_info: crate::gateway::tauri_api::CertificateInfo,
    ) -> anyhow::Result<crate::gateway::tauri_api::GeneratedCertificate> {
        ...
        let cert = crate::gateway::tauri_api::GeneratedCertificate {
    ...
    ///
    /// 规则 ID
    pub async fn add_access_rule(&self, rule: crate::gateway::tauri_api::AccessRule) -> anyhow::Result<String> {
    ...
    ///
    /// 规则列表
    pub async fn get_access_rules(&self) -> anyhow::Result<Vec<crate::gateway::tauri_api::AccessRule>> {
        let rules: Vec<crate::gateway::tauri_api::AccessRule> = self
            .access_rules
            .iter()
    ...
    ///
    /// 活跃会话列表
    pub async fn get_active_sessions(&self) -> anyhow::Result<Vec<crate::gateway::tauri_api::ActiveSession>> {
        let sessions: Vec<crate::gateway::tauri_api::ActiveSession> = self
            .active_sessions
            .iter()
            .map(|entry| entry.value().clone())
            .collect();
    ...
    ///
    /// 操作结果
    pub async fn add_active_session(&self, session: crate::gateway::tauri_api::ActiveSession) -> anyhow::Result<()> {
